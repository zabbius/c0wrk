import type { ModelProfilesBuiltinTool, ModelProfilesToolGroup } from '@/types/models'

/**
 * One selectable entry in the Model Profiles "Always-present tools" picker.
 *
 * The picker mixes two kinds of entry:
 *   - a **cluster** (see `ModelProfilesToolGroup`): picking it pins every member at
...
/**
 * Candidate entries for the Model Profiles "Always-present tools" picker.
 *
...
export function essentialToolPickerOptions(
  builtinTools: readonly ModelProfilesBuiltinTool[],
  toolGroups: readonly ModelProfilesToolGroup[],
