...
| Embedding execution provider (GPU/CUDA), `fetch-onnx-gpu` packaging, embedding fallback semantics, GPU release artifact & flavor-pinned updates | [decisions/039-gpu-embedding-provider.md](decisions/039-gpu-embedding-provider.md), [decisions/040-cuda-release-artifact.md](decisions/040-cuda-release-artifact.md), [domains/workspace.md](domains/workspace.md) (Embedding Execution Provider section) |
