...
| Shell path extraction, command substitution, symlink/containment false positives | [architecture/security-model.md](architecture/security-model.md), [decisions/040-validated-command-substitution.md](decisions/040-validated-command-substitution.md) |
...
| Subagent Profiles (`.agents/agents`, `#agent-name` mentions, profile-required skills) | [decisions/021-subagents.md](decisions/021-subagents.md), [decisions/039-agent-profile-skills.md](decisions/039-agent-profile-skills.md) |
