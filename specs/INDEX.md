...
- [035-remove-small-llm-tool-budget.md](decisions/035-remove-small-llm-tool-budget.md) - Remove the Small-LLM tool budget: drops ADR-022's Essential Tools `max_tools` slot budget, router tool matching, and the `tools_assigned`/over-budget diagnostics (every other ADR-022 decision stands)
