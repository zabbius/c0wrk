...
- [decisions/040-validated-command-substitution.md](../decisions/040-validated-command-substitution.md) - the assignment-form exception to the shell-expansion rule (validated command substitution) and its accepted residual risk
