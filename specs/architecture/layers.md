...
- `core/modelprofiles/` — tool-set narrowing for running the conductor against local / mid-size LLMs (model profiles; see [../domains/model-profiles.md](../domains/model-profiles.md))
