...
- [../decisions/042-gpu-embedding-provider.md](../decisions/042-gpu-embedding-provider.md) — embedding execution-provider selection (auto/CPU/CUDA), fallback transparency, locked-thread execution, GPU packaging
