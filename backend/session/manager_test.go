...
func (m *mockSessionStoreForRestore) LoadSessionHistory(_ context.Context, _ string) ([]ChatMessage, error) {
	return []ChatMessage{}, nil
}
...
func (m *mockSessionStoreForRestore) ReplaceStepTodoUpdate(_ context.Context, _, _ string, _ ChatMessage) error {
	return nil
}
