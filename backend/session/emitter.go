...
// SetModelProfile snapshots the Model Profiles profile state the session runs
...
func (e *EventEmitter) SetModelProfile(info ModelProfilesMetaInfo) {
	e.metrics.setModelProfiles(info)
}
